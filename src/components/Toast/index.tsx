...
const Toast = ({ message }: ToastProps) => {
  return (
    <div
      id="toast-success"
      className="absolute top-24 right-4 z-50 mb-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
      role="alert"
    >
